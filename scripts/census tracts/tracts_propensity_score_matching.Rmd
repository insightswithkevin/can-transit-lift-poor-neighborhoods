---
title: "Propensity Score Matching - Census Tracts"
...
love.plot(modmatch_genetic, stats = c("mean.diffs", "variance.ratios", "ks"),
          ...
          title = "",
          var.names = c(
            hgh_nc_ = "Zuzug einkommensstarker Individuen",
...
st_write(matched_data_2013, here("data/census tracts/outputs/matched_data_2013.shp"), delete_layer=TRUE)
